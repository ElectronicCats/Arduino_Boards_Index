...
/*Digital 0*/{ PORTA, 14, PIO_DIGITAL,  (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_EXTINT), ADC_Channel6,   PWM0_CH0,   TCC0_CH0,      EXTERNAL_INT_NMI }, // 0
/*Digital 1*/{ PORTA, 14, PIO_DIGITAL,  (PIN_ATTR_ANALOG|PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_EXTINT), ADC_Channel6,   PWM0_CH0,   TCC0_CH0,      EXTERNAL_INT_NMI }, // 1
...
/*Digital 5*/ { PORTA, 15, PIO_OUTPUT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),                                 No_ADC_Channel, PWM2_CH0,   TC2_CH0,       EXTERNAL_INT_NONE },// 5 
/*unused  6 */{ NOT_A_PORT, 0, PIO_OUTPUT, (PIN_ATTR_DIGITAL/*|PIN_ATTR_PWM*/),                             No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,  EXTERNAL_INT_NONE },// 6
/*SWDDIO 7  */{ PORTA, 31, PIO_OUTPUT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),                                 No_ADC_Channel, PWM2_CH1,   TC2_CH1,       EXTERNAL_INT_NONE },// 7
