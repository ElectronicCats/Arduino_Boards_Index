...
const PinDescription g_APinDescription[]=
{
        ...
        // 43..46 - SPI Header
        //{ PORTB, 30, PIO_TIMER_ALT, (PIN_ATTR_TIMER_ALT), (PIN_ATTR_DIGITAL|PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE }, // S43
        { PORTB, 30, PER_TIMER, (PER_ATTR_TIMER_ALT), No_ADC_Channel, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SERCOM4/PAD[2]
        ...
        { PORTB, 31, PER_TIMER, (PER_ATTR_TIMER_ALT), No_ADC_Channel, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SERCOM4/PAD[1]
        ...
        { PORTB, 3, PIO_MULTI, PER_ATTR_DRIVE_STRONG, (PIN_ATTR_ADC|PIN_ATTR_DIGITAL|PIN_ATTR_EXTINT), NOT_ON_TIMER, ADC_Channel11, EXTERNAL_INT_3, GCLK_CCL_NONE }, // 49
         ...
         // 50 - 52 LORA Radio 
        { PORTB, 0, PIO_MULTI, (PER_ATTR_DRIVE_STRONG), No_ADC_Channel, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SERCOM4/PAD[2]
        { PORTC, 19, PER_TIMER, (PER_ATTR_TIMER_ALT), No_ADC_Channel, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SERCOM4/PAD[0]
        { PORTC, 18, PER_TIMER, (PER_ATTR_TIMER_ALT), No_ADC_Channel, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SERCOM4/PAD[3]
