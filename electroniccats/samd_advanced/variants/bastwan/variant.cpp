...
const PinDescription g_APinDescription[]=
{
        ...
        // 50..54 - RF SPI PINS 
        //50 SS
        {PORTB, 31, PIO_SERCOM_RF,(PER_ATTR_TIMER_ALT), (PIN_ATTR_DIGITAL | PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE}, // SEL 
        //51 MOSI
        {PORTB, 30, PIO_SERCOM_RF, (PER_ATTR_TIMER_ALT), (PIN_ATTR_DIGITAL | PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE}, // MOSI SERCOM4 PAD2 // MOSI SERCOM4 PAD2
        //52 MISO
        {PORTC, 19, PIO_SERCOM_RF, (PER_ATTR_TIMER_ALT), (PIN_ATTR_DIGITAL | PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE},
        //53 SCK
        {PORTC, 18, PIO_SERCOM_RF, (PER_ATTR_TIMER_ALT), (PIN_ATTR_DIGITAL | PIN_ATTR_SERCOM), NOT_ON_TIMER, No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE}, // SCK  SERCOM4 PAD3
        //54 RFM RST
