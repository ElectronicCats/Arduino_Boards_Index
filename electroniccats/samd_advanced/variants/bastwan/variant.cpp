...
const PinDescription g_APinDescription[]=
{
        ...
        {PORTB, 30, PIO_SERCOM_RF, (PER_ATTR_TIMER_ALT), No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE}, // MOSI SERCOM4 PAD2
        {PORTC, 19, PIO_SERCOM_RF, (PER_ATTR_TIMER_ALT), No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE}, // MISO SERCOM4 PAD0
        {PORTC, 18, PIO_SERCOM_RF, (PER_ATTR_TIMER_ALT), No_ADC_Channel, EXTERNAL_INT_NONE, GCLK_CCL_NONE}, // SCK  SERCOM4 PAD3
